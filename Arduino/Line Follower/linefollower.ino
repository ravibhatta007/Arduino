...
int speed1 = 10, speed2 = 9, direction1 = 12, direction2 = 11;
// starting speed and rotation offset
int startSpeed = 60, rotate = 20;
// sensor threshold
int threshhold = 5;
int left = startSpeed, right = startSpeed;

int button = 2;                     // button pin (optional)
int motorsOff = false;               // motors initially off until button pressed.
